...
const Feed = ({ feedInfo, following, followingRefetch, feedRefetch }) => {
    ...
    const { data: sharers, refetch: sharersRefetch } = useQuery(
        `sharers_${answer_id}`,
        () =>
            fetch(`http://localhost:5500/sharers/${answer_id}`).then((res) =>
                res.json()
            )
    );
    ...
    return (
        <section className="mb-2 shadow-lg card">
            ...
            <div className="p-0 py-5">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div>
                            <Dropdown
                                ...
                                inline={true}
                                label={
                                    <BsThreeDots className="text-2xl m-0 p-0" />
                                }
                            >
                                <Dropdown.Item
                                    onClick={() =>
                ...
                {/* Separator */}
                <div className="w-full h-px bg-blue-100 mb-4 mt-4"></div>
                ...
                <div className="px-5">
                    ...
                    <div className="flex gap-5">
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: upvoteInfo[user?.user_email]
                                    ? '#DBEAFE'
                                    : ' ',
                                color: upvoteInfo[user?.user_email]
                                    ? '#2563EB'
                                    : '',
                            }}
                            //
            ...
            >
                <div className="p-5">
                    <p className="">
                        You delete this post, it will be gone forever. Even if
                        cry till you death it will be gone for good.
                    </p>
                    <div className="w-fit ml-auto flex gap-5 mt-3">
                        ...
                        <button
                            ...
                            onClick={() =>
                                handleDete({ answer_id, feedRefetch })
                            }
                        >
                            Delete
                        </button>
